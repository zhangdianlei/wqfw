...
<script type="text/javascript">uaredirect("<?=$mymps_global['SiteUrl']?>/m/index.php?mod=goods&id=<?=$id?>");</script>
...
<?php } ?>    <script type="text/javascript" src="<?=$mymps_global['SiteUrl']?>/template/global/messagebox.js"></script>
<div class="body1000">
<div class="clear"></div>
...
<ul class="cfix">
                        <?php $relategoods = mymps_get_goods(6,1,NULL,$goods['catid'],NULL,NULL,$city['cityid']); ?>                        <?php if(is_array($relategoods)){foreach($relategoods as $relate) { ?><li> <b><a href="<?=$relate['uri']?>" target=_blank><img src="<?=$mymps_global['SiteUrl']?><?=$relate['picture']?>" alt=""  width="130" height="120"/></a></b> <span class="price"><?=$relate['nowprice']?><del>￥<?=$relate['old_price']?></del></span> <span class="title"><a href="<?=$relate['uri']?>"  target=_blank><? echo cutstr($relate['goodsname'],20); ?></a></span> </li>
<?php }} ?>
</ul>
</div>
</div>
