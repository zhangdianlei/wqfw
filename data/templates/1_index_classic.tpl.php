...
<div class="focushead_right">
                <div class="daohang indexdh">
                    <ul>
                        ...
                        <?php }} ?>
<li><a target="_self" id="7" href="http://www.wqfw.vip/about.php?part=aboutus&id=3"><font color="">联系我们</font><sup class=""></sup></a></li>
                    </ul>
                </div>
                        ...
                        <div class="announcecorp">
                            ...
                            <div id="tablist1">
                                ...
                                <div class="tablist none corp">
                                    <ul>
                                    <?php if(ifplugin('news')) $news = mymps_get_news(7,NULL,NULL,NULL,NULL,1,$cityid); ?>                                    <?php if(is_array($news)){foreach($news as $mymps) { ?>                                    <li><span class="title"><a target="_blank" href="<?=$mymps['uri']?>" title="<?=$mymps['title']?>" <? if($mymps['iscommend'] ==1) { ?>style="color:red"<?php } ?>><? echo cutstr($mymps['title'],42); ?></a></span><span class="time">[<? echo GetTime($mymps['begintime'],'m-d'); ?>]</span></li>
                                    <?php }} else {{ ?>
                                    <div class="nodata">暂无相关记录！</div>
                                    <?php }} ?>
                                    </ul>
